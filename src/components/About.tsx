    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-16 sm:mb-20">
          ...
          <div className="relative px-4 mt-8 lg:mt-0">
            <img
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-16 sm:mb-20 px-4">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="inline-flex items-center justify-center w-12 sm:w-16 h-12 sm:h-16 bg-green-600 text-white rounded-full mb-3 sm:mb-4">
                {stat.icon}
              </div>
        ...
        <div className="text-center mb-8 sm:mb-12 px-4">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            Get to know the people who make Givmi possible.
          </p>
        </div>
          ...
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
              <img
                src={member.image}
                alt={member.name}
                className="w-20 sm:w-24 h-20 sm:h-24 rounded-full mx-auto mb-4 sm:mb-6 object-cover"
              />
              <h4 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">{member.name}</h4>
              <p className="text-green-600 font-medium mb-3 sm:mb-4 text-sm sm:text-base">{member.role}</p>
        ...
        {/* Values Section */}
        <div className="mt-16 sm:mt-20 bg-white rounded-3xl p-6 sm:p-8 md:p-12 mx-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="w-12 sm:w-16 h-12 sm:h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <Heart className="h-6 sm:h-8 w-6 sm:w-8 text-green-600" />
              </div>
              <h4 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Customer First</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Quality Excellence</h4>
              <p className="text-gray-600 text-sm sm:text-base">
            ...
            <div className="text-center">
              <div className="w-12 sm:w-16 h-12 sm:h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <Globe className="h-6 sm:h-8 w-6 sm:w-8 text-green-600" />
              </div>
              <h4 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Global Impact</h4>
              <p className="text-gray-600 text-sm sm:text-base">
